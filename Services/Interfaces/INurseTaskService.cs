...
namespace HospitalManagementSystem.Services
{
    public interface INurseTaskService
    {
        ...
        Task<NurseTaskDto?> GetTaskByIdAsync(string id, string userId, string userRole);
        ...
        Task<NurseTaskDto> UpdateTaskAsync(string id, UpdateNurseTaskDto updateDto, string updatedBy, string userRole);
        Task<bool> DeleteTaskAsync(string id);
        Task<bool> DeleteTaskAsync(string id, string userId, string userRole);
        ...
        Task<List<NurseTaskDto>> GetTasksByDoctorIdAsync(string doctorId);
